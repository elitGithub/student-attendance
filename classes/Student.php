...
class Student
{
    ...
    public function insertAttendance($attend = [])
    {
        ...
        if ($data_insert) {
            return "<div class='alert alert-success'><strong>Success !</strong> Attendance data inserted successfully !</div>";
        } else {
            return "<div class='alert alert-danger'><strong>Error !</strong> Attendance data not inserted !</div>";
        }
    }
